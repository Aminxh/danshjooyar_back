...
//        course.RemoveStudent(student);
    ...
    public void Score(Course course, Student student, double score) {
        ...
        if(getCourses().get(getCourses().indexOf(course)).getStudents().get(getCourses().get(getCourses().indexOf(course)).getStudents().indexOf(student)).getTerms().getLast().getStudentCourses().get(i).getName()==course.getName()){
